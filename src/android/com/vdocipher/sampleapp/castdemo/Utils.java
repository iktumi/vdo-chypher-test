...
public class Utils {
    ...
    public static Pair<String, String> getSampleOtpAndPlaybackInfo() throws IOException, JSONException {
        ...
        if (responseCode == 200) {
            ...
            String otp = "20160313versASE323fv1BosTKfjVZ08mF1JkxIMCReRcZx98ecNxdvMmTdkTGNW";//jObj.getString("otp");
            String playbackInfo = "eyJ2aWRlb0lkIjoiYjhiNTUxMjhkNDdhOWFkNmY4Y2M1YTAwYTVmYTc4NzAifQ==";//jObj.getString("playbackInfo");
